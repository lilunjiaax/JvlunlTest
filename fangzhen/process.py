...
def business_design_module(user_dir):
    ...
    mouse_click(935, 582)
    mouse_click(1116, 760)
    # pull_mouse(612, 618, 899, 460)
    # pull_mouse(610, 663, 1020, 463)
    # pull_mouse(615, 437, 1146, 463)
    # pull_mouse(610, 481, 1270, 463)
    # pull_mouse(608, 528, 897, 595)
    # pull_mouse(615, 569, 1023, 595)
    # pull_mouse(609, 395, 1150, 595)
    # todo: 根据字段识别顺序，拉动
...
# business_design_module('C:\\Users\\jvlunl\\Desktop\\test1\\仿真系统\\resources\\20191104\\15251853026')
# if '产品流程.png' in os.listdir(os.path.dirname(PRODUCT_FLOW_PNG)):
#         os.rename(PRODUCT_FLOW_PNG, os.path.join(os.path.dirname(PRODUCT_FLOW_PNG), str(time.time()).replace('.', '')+'.png'))
# time.sleep(10)
# save_picture(631, 375, 773, 680, os.path.dirname(PRODUCT_FLOW_PNG), '产品流程')
...
def submit_file():
    ...
    mouse_click(155, 150)
    time.sleep(2)
    pull_mouse(155, 150, 155, 65)
    mouse_click(81, 99)
    mouse_click(751, 180)
    time.sleep(2)
    pull_mouse(751, 180, 751, 300)
    mouse_click(397, 311)
    mouse_click(600, 400)
    time.sleep(10)
    pull_mouse(1911, 412, 1911, 670)
    time.sleep(2)
    # 点击提交
    mouse_click(943, 850)

def submit_file_firefox():
    mouse_click(657, 963)
    time.sleep(5)
    mouse_click(155, 280)
    time.sleep(2)
    pull_mouse(155, 270, 155, 100)
    mouse_click(74, 136)
    mouse_click(944, 273)
    time.sleep(2)
    pull_mouse(944, 273, 944, 460)
    mouse_click(327, 430)
    mouse_click(789, 489)
    time.sleep(10)
    pull_mouse(1911, 412, 1911, 670)
...
# 开始页面校验截图
# time.sleep(10)
# save_picture(466, 272, 1420, 804, Benchmark, '学校firefox')




# time.sleep(10)
# save_picture(1065, 426, 1181, 467, 'C:\\Users\\jvlunl\\Desktop\\test1\\仿真系统\\resources\\login_jpg','测试firefox坐标')
