...
def basis(user_dir):
    ...
    # 公司简介页面截图
    save_picture(466, 272, 1420, 804, user_dir, '公司简介页面')
    time.sleep(10)
...
def resource_configuration_module(user_dir):
    """资源配置模块"""
    # 填写用户人数
    save_picture(466, 272, 1420, 804, user_dir, '用户数预测')
...
# resource_configuration_module('C:\\Users\\jvlunl\\Desktop\\test1\\仿真系统\\resources\\20191104\\15251853026')


def business_design_module(user_dir):
    """业务设计模块"""
    # action1:填写预计套餐费用
    ...
    # action4:设计挽留业务
    mouse_click_and_input_content(826, 506, '90')
    mouse_click_and_input_content(970, 506, '90')
    mouse_click_and_input_content(1150, 506, '90')
    mouse_click_and_input_content(824, 557, '90')
    mouse_click_and_input_content(966, 557, '90')
    mouse_click_and_input_content(1153, 557, '90')
    mouse_click_and_input_content(827, 608, '90')
    mouse_click_and_input_content(968, 608, '90')
    mouse_click_and_input_content(1148, 608, '90')
    mouse_click(943, 659)
...
def profit_and_loss_measurement_module(user_dir):
    """损益测算模块"""
    ...
    time.sleep(2)
    much_mouse_click(1116, 760, 2, 2)
    save_picture(466, 272, 1420, 804, user_dir, '实验结果-未记录')
    # 点击记录
    time.sleep(2)
...
logger.info("资源配置开始")
resource_configuration_module('C:\\Users\\Public\\Pictures')

logger.info("商业配置开始")
business_design_module('C:\\Users\\Public\\Pictures')

logger.info("市场配置开始")
marketing_module()

logger.info("利润损失配置开始")
profit_and_loss_measurement_module('C:\\Users\\Public\\Pictures')
...
time.sleep(40)
save_picture(0, 0, 1900, 900, 'C:\\Users\\Public\\Pictures', '用户数预测')
